...
func (c *EdpV1Client) Get(name string, namespace string, options metav1.GetOptions) (result *jenkinsV1api.JenkinsServiceAccount, err error) {
...
func (c *EdpV1Client) Create(jsa *jenkinsV1api.JenkinsServiceAccount, namespace string) (result *jenkinsV1api.JenkinsServiceAccount, err error) {
	result = &jenkinsV1api.JenkinsServiceAccount{}
	err = c.crClient.Post().
		Namespace(namespace).
		Resource("jenkinsserviceaccounts").
...
func (c *EdpV1Client) Update(jsa *jenkinsV1api.JenkinsServiceAccount) (result *jenkinsV1api.JenkinsServiceAccount, err error) {
	result = &jenkinsV1api.JenkinsServiceAccount{}
	err = c.crClient.Put().
