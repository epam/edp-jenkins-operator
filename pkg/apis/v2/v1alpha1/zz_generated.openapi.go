...
func schema_pkg_apis_edp_v1alpha1_CDStageJenkinsDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CDStageJenkinsDeployment is the Schema for the cdstagejenkinsdeployments API",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/edp/v1alpha1.CDStageJenkinsDeploymentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/edp/v1alpha1.CDStageJenkinsDeploymentStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/edp/v1alpha1.CDStageJenkinsDeploymentSpec", "./pkg/apis/edp/v1alpha1.CDStageJenkinsDeploymentStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_edp_v1alpha1_CDStageJenkinsDeploymentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CDStageJenkinsDeploymentSpec defines the desired state of CDStageJenkinsDeploymentSpec",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"job": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_edp_v1alpha1_CDStageJenkinsDeploymentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CDStageJenkinsDeploymentStatus defines the observed state of CDStageJenkinsDeployment",
				Type:        []string{"object"},
			},
		},
	}
