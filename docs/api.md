...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          role type, available options: globalRoles, projectRoles, nodeRoles<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>ownerName</b></td>
        <td>string</td>
        <td>
          Property indicates which jenkins car should be taken to initialize correct client.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
